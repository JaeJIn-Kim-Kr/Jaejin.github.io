        ...
        <div class="w-full">
            ...
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="/create_todoList" method="post" >
                ...
                <div class="mb-4">
                    ...
                    <textarea class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" name="content">{{ old('content') }}</textarea>
